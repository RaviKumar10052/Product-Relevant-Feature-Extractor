...
"""
def main():
	review_data_file_name = "review.txt" # The file in the current directory that conains the raw review data
	...
	while line:
		...
		try:
			...
			elif new_file_flag and line[0].split('/')[1] == "name":
				new_file_flag = False
			...
			input("Press any key to end the execution of the current script")
			exit()
	fin.close()
	f_map.close()
